...
void loop() {
  // utilizzo l'input analogico A4 come starter (quando premo il pulsante rileva una tensione e farà partire il programma)
  ...
  if (start > 3.0) {
    ...
    for(int T=0;T<3;T++) { // il numero di periodi (3) per cui diamo in uscita l'onda quadra
    
      digitalWrite(13, HIGH); // imposto il pin 13 su HIGH, fronirà una tensione di 5V
      ...
      digitalWrite(13, LOW); // imposto il pin 13 su LOW, fronirà una tensione di 0V
